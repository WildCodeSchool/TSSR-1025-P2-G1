...
while ($true)
{
    ...
    while ($true)
    {
        ...
        {
            Write-Host "Le Poste client demandé n'existe pas sur notre réseaux veuillez mentionner un PC existant dans notre réseau."
            Write-Host ""
    ...
    {    
        $os_type="linux"
        Write-Host "Système détecté : Linux"
    }
    else
    {
        $os_type="windows"
